            ...
            <div>
                <h6 class="dcmt-view-card-title mb-0">
                    ...
                    <span class="ms-3 dcmt-view-card-title-total">
                        (<?php echo trans('patient', 'showing'); ?>: <span style="color: #007bff; font-weight: 600;"><?php echo number_format($total_records); ?></span> <?php echo trans('patient', 'records'); ?>)
                    </span>
                </h6>
            </div>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo trans('patient', 'email'); ?></th>
                    ...
                    <tbody>
                        <?php foreach ($patients as $patient): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="history.php?id=<?php echo $patient['dcmt_id']; ?>" title="<?php echo trans('patient', 'history'); ?>">
                                        <i class="far fa-file-alt text-info" style="font-size: 1.2rem;"></i>
                                    </a>
                                </td>
                                <td>
                                    <div class="btn-group btn-group-sm btn-group-action" role="group">
                                        <a href="view.php?id=<?php echo $patient['dcmt_id']; ?>" class="btn" title="<?php echo trans('common', 'view'); ?>">
                                            <img src="../../assets/images/view-filled.svg" alt="View">
                                        </a>
                                        <a href="edit.php?id=<?php echo $patient['dcmt_id']; ?>" class="btn" title="<?php echo trans('common', 'edit'); ?>">
                                        ...
                                        if ($patient_has_records): ?>
                                            <button type="button" class="btn dcmt-disabled-lock-btn" title="<?php echo trans('patient', 'cannot_delete_has_records'); ?>" disabled>
