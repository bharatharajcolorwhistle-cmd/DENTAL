...
return [
    ...
    "audit_income_added" => "Income Added",
    "audit_income_updated" => "Income Updated",
    "audit_income_deleted" => "Income Deleted",
    "audit_payment_marked_complete" => "Payment Marked as Complete",
    "audit_total_payment" => "Total Payment",
    "audit_total_income" => "Total Income",
