<?php
/**
 * English Translations - Patient Notes
 */
...
return [
    ...
    "add_note" => "Add Note",
    "add_odontogram" => "Add Odontogram",
    "edit_odontogram" => "Edit Odontogram",
    "save_odontogram" => "Save Odontogram",
    "odontogram_record" => "Odontogram",
    "odontogram_record_summary" => "Dental chart(s): problem (initial condition) and/or solution (treatment).",
    "odontogram_one_per_patient" => "Each patient has one odontogram chart (shown first in clinical history).",
    "odontogram_save_success" => "Odontogram saved successfully",
    "edit_note" => "Edit Note",
    "view_note" => "View Note",
    ...
    "records" => "records",
    "showing" => "Showing",
    "search_placeholder" => "Search by topic or note text",
    ...
    "note_help" => "Add detailed notes about the patient's visit, treatment, or any other relevant information.",
    "topic_placeholder" => "Enter topic or subject...",
    "topic_help" => "Optional: Add a topic or subject for this note to help categorize it.",
    "note_date_help" => "Select the date for this note",
    "note_date_required" => "Note date is required",
