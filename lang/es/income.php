...
return [
    ...
    "audit_income_added" => "Ingreso agregado",
    "audit_income_updated" => "Ingreso actualizado",
    "audit_income_deleted" => "Ingreso eliminado",
    "audit_payment_marked_complete" => "Pago marcado como completado",
    "audit_total_payment" => "Pago total",
    "audit_total_income" => "Ingreso total",
    "audit_bulk_delete" => "Eliminación masiva",
