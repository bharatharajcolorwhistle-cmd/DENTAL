...
return [
    ...
    "bulk_delete_partial" => "{deleted} métodos de pago eliminados. {skipped} no se pudieron eliminar porque son predeterminados del sistema o se usan en registros de ingresos.",
    "bulk_delete_none" => "Ninguno de los métodos de pago seleccionados se pudo eliminar. Los predeterminados del sistema y los que se usan en ingresos no se pueden eliminar.",
